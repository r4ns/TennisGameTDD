...
public class NumericScores {
	...
	@Test
	public void test_winPlayer1AfterDeuce()  throws TennisGameException{
		TennisGame game = new TennisGame();
		game.player2Score();
		game.player1Score();
		game.player2Score();
	...
	@Test
	public void test_winPlayer2AfterDeuce()  throws TennisGameException{
		TennisGame game = new TennisGame();
		game.player2Score();
		game.player1Score();
		game.player2Score();
	...
	public void testExceptionOne() throws TennisGameException{
		TennisGame game = new TennisGame();
		game.player1Score();
		game.player1Score();
		game.player1Score();
	...
	@Test(expected=TennisGameException.class)
	public void testExceptionTwo() throws TennisGameException{
		TennisGame game = new TennisGame();
		game.player2Score();
		game.player2Score();
		game.player2Score();
